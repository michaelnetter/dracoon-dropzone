 ...
 *
 */
public class MyPopOverSkin implements Skin<PopOver> {
    ...
    public MyPopOverSkin(final PopOver popOver, double width, double height) {
        ...
        stackPane.minHeightProperty().bind(new SimpleDoubleProperty(height));
